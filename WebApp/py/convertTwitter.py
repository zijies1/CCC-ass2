...
geometry_aus2 = '../webpack-react/src/data/aurinObese.json'
geometry_aus3 = '../webpack-react/src/data/aurinOverweight.json'
...
def read_and_write_aurin(filename,indicator):
  ...
  try:
      ...
      for area in list:
          ...
          id = count
          size = area["properties"][indicator]
...
def main3():
    read_and_write_aurin(geometry_aus2,"est_ppl_18yrs_plus_obese_2014_15_num")
    read_and_write_aurin(geometry_aus3,"est_ppl_18yrs_plus_ovrwht_2014_15_num")

    # est_ppl_18yrs_plus_obese_2014_15_num
    # est_ppl_18yrs_plus_ovrwht_2014_15_num
    # Estimated Number Of People Aged 18 Years And Over Who Undertook No Or Low Exercise In The Previous Week
    # est_ppl_18yrs_plus_lo_exc_prev_wk_2014_15_num
